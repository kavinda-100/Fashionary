...
function Footer() {
  ...
  return (
    <footer className="w-full h-auto bg-black px-[10%] md:px-0">
    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col items-start px-6 pt-6">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-3xl capitalize">Get shoes ready for the new term at your nearest Fashionary store. Find Your perfect items in store. Get Rewards.</p>
